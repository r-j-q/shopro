    ...
    export default{
        ...
        methods:{
            ...
            /*     let headerImg = await this.getImageInfo(this.headerImg)
                ...
                //小程序码
                let qrcodeImg = await this.getImageInfo('https://cdn.uviewui.com/uview/swiper/2.jpg')
                this.ctx.drawImage(qrcodeImg+'?t='+a,uni.upx2px(384),(((this.canvasW-hW) / 2) + hH + uni.upx2px(200)), uni.upx2px(156), uni.upx2px(156))
                //延迟渲染
                setTimeout(()=>{
